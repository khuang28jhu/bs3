...
def main():
    ...
    if oneline[0]=="@":
        original_bs_reads, all_raw_reads = b4utils.parse_fastq(read_file, outfile2, 1)
        if asktag=="Y":
            original_bs_reads, all_raw_reads = b4utils.parse_fastq(read_file, outfile3, 2)
    elif oneline[0]==">":
        original_bs_reads, all_raw_reads = b4utils.parse_fasta(read_file, outfile2, 1)
        if asktag=="Y":
            original_bs_reads, all_raw_reads = b4utils.parse_fasta(read_file, outfile3, 2)
    else:
